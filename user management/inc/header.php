        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php }else{ ?>
              ...
              <?php
                         ...
                         ?>">
                <a class="nav-link" style="color :black" href="register.php"><i class="fas fa-user-plus mr-2"></i>Register</a>
              </li>
              <li class="nav-item
                <?php
                    			 ...
                    			 ?>">
                <a class="nav-link" style="color :black" href="login.php"><i class="fas fa-sign-in-alt mr-2"></i>Login</a>
              </li>
